...
const {  state, saveCreds } =await useMultiFileAuthState(`./sessions`)
   ...
   if (pairingCode && !XeonBotInc.authState.creds.registered) {
      ...
      setTimeout(async () => {
         ...
         console.log(chalk.black(chalk.bgGreen(`Your Pairing Code ; votre code d'appairege : `)), chalk.black(chalk.white(code)))
      }, 3000)
   }
//------------------------------------------------------
...
│
│ *FAMOUS-TECH  x  DYBY-TECH*
└─────────
// *FAMOUS XD konekte nan WhatsApp ou kounya wap bezwen deploye l pou li ka aktive* 
*GITHUB* : https://github.com/Famous-Tech/FAMOUS-XD

*Channel* : https://whatsapp.com/channel/0029VabMnWT7dmejN43jZ533

*Group* :  https://chat.whatsapp.com/JnG9253HRmsLN0DlPFkzjK
└─────────\n\n\n` });
            ...
            await delay(1000 * 2) 
             ...
             await XeonBotInc.sendMessage(XeonBotInc.user.id, { text:
               `⚠️ *Sa se creds.json ou sèvi avè l pou deploye bot lan*\n
┌─❖
│ *FAMOUS XD*🔰🇭🇹 
└┬❖  
┌┤✑ 𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐝 𝐁𝐲
